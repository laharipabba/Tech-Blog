...
int uid = ((user) session.getAttribute("currentUser")).getId();
...
if(cid == 0){
    ...
    posts = d.getPostByUserAndCategory(uid, cid);
}
...
<div class="col-md-6 mt-3">
    <div class="card shadow-sm h-100 d-flex flex-column">
        <% if(p.getpPic() != null && !p.getpPic().isEmpty()) { %>
            <img class="card-img-top" src="blog_pics/<%= p.getpPic() %>" alt="Post Image"
                 style="width:100%; height:200px;  border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <% } %>
